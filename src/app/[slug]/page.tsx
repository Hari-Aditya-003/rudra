  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-10">
      ...
      <div className="relative overflow-hidden rounded-3xl shadow-lg">
        <div className="absolute inset-0" style={{ background: `linear-gradient(135deg, ${NAVY} 0%, ${NAVY_SOFT} 100%)` }} />
      ...
      <div className="mt-8 rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <a href="/training#courses" className="inline-flex items-center gap-2 rounded-lg border border-neutral-300 px-5 py-3 font-semibold hover:bg-neutral-50">
            Back to all courses
          </a>
        </div>
      </div>
