...
export default function ScheduleModal({
  ...
  return (
    <div className="fixed inset-0 z-[1200]">
      ...
      />
      {/* Sheet */}
      <div className="absolute inset-x-0 bottom-0 mx-auto w-[min(940px,92vw)] rounded-t-2xl bg-white shadow-2xl ring-1 ring-black/5">
        {/* Header */}
        ...
        <div className="grid gap-6 p-5 md:grid-cols-[1.1fr_.9fr] md:p-7">
          ...
          <div className="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm md:p-5">
            ...
            <p className="mt-1 text-sm text-neutral-600">
              Share your details and preferred center. We’ll confirm the next
              available batch.
            </p>
            ...
            >
              <input
                className="w-full rounded-lg border border-neutral-300 px-3 py-2 text-sm outline-none placeholder:text-neutral-400 focus:ring-2 focus:ring-sky-200"
              ...
              <div className="grid grid-cols-2 gap-3">
                <input
                  className="rounded-lg border border-neutral-300 px-3 py-2 text-sm outline-none placeholder:text-neutral-400 focus:ring-2 focus:ring-sky-200"
                  placeholder="Phone"
                />
                <input
                  className="rounded-lg border border-neutral-300 px-3 py-2 text-sm outline-none placeholder:text-neutral-400 focus:ring-2 focus:ring-sky-200"
              ...
              <textarea
                className="min-h-[92px] rounded-lg border border-neutral-300 px-3 py-2 text-sm outline-none placeholder:text-neutral-400 focus:ring-2 focus:ring-sky-200"
                placeholder="Any questions or timing preference?"
              />
              <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-sky-600 px-4 py-2 text-sm font-semibold text-white hover:bg-sky-700">
                Submit Request <ArrowRight className="h-4 w-4" />
              </button>
              <div className="mt-2 flex items-center gap-2 text-xs text-neutral-500">
                <Clock className="h-3.5 w-3.5" /> Typical response: within a
                business day
              </div>
            ...
            <div className="mt-5 rounded-lg bg-sky-50 p-3 text-xs text-sky-900 ring-1 ring-sky-100">
              DGCA-compliant curriculum • Licensed trainers • Flight hours on
              real missions
            </div>
          </div>
        </div>
